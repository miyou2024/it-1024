...
export class ValidationRequestPipe implements PipeTransform {
  ...
  async transform(value: any, metadata: ArgumentMetadata) {
    ...
    this.nestjsBootstrapService.appendRequestLog(id, {
    ...
    if (errors.length) {
      this.nestjsBootstrapService.appendRequestLog(id, errors);
      ...
      this.nestjsBootstrapService.appendRequestLog(id, 'ValidationPipe.transform:Success');
      this.traceLogger.debug(
        {
          BodySuccess: 'Success',
        },
